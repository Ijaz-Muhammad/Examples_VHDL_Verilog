...
#
# Mem_block.tcl: Tcl script for re-creating project 'Mem_block'
#
# Generated by Vivado on Fri Jul 31 17:06:19 +0300 2026
...
#
# 1. This project restoration tcl script (Mem_block.tcl) that was generated.
#
...
#
#    "D:/Practic_dir/vhdl/Memory/Mem_Ip/MATLAB/mysine.coe"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/MATLAB/mysine.coe"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/MATLAB/mysine.coe"
...
proc cr_bd_design_1 { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {d:/Practic_dir/vhdl/Memory/Mem_Ip/MATLAB/mysine.coe} \
  ...
  connect_bd_net -net CLK_0_1 [get_bd_ports CLK] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins c_counter_binary_0/CLK]
  ...
  connect_bd_net -net ena_0_1 [get_bd_ports ena] [get_bd_pins blk_mem_gen_0/ena]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-369,-343",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port port-id_CLK -pg 1 -lvl 0 -x -10 -y -120 -defaultsOSRD
preplace port port-id_ena -pg 1 -lvl 0 -x -10 -y -100 -defaultsOSRD
preplace portBus dout -pg 1 -lvl 3 -x 470 -y -80 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 2 -x 350 -y -90 -defaultsOSRD
preplace inst c_counter_binary_0 -pg 1 -lvl 1 -x 120 -y -50 -defaultsOSRD
preplace netloc CLK_0_1 1 0 2 10 -120 240
preplace netloc blk_mem_gen_0_douta 1 1 2 250 -190 450J
preplace netloc c_counter_binary_0_Q 1 1 1 230 -110n
preplace netloc ena_0_1 1 0 2 20J -110 220J
levelinfo -pg 1 -10 120 350 470
pagesize -pg 1 -db -bbox -sgen -80 -200 590 120
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/work/Mem_block.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Mem_block.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Mem_block.srcs/utils_1/imports/impl_1" -objects $obj
